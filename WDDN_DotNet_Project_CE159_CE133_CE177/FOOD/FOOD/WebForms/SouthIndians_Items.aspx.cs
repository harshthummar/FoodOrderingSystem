...
{
    public partial class SouthIndians_Items : System.Web.UI.Page
    {
        ...
        protected void mycard1_Click1(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string ins = "Insert into[MyCard](Name,Price,Quantity,Email) values('" + paperdosa.Text + "','" + e1 + "','" + Label1.Text + "','" + Session["email"] + "')";
        ...
        protected void mycard2_Click1(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string ins = "Insert into[MyCard](Name,Price,Quantity,Email) values('" + masaladosa.Text + "','" + e2 + "','" + Label2.Text + "','" + Session["email"] + "')";
                SqlCommand com = new SqlCommand(ins, con);
        ...
        protected void mycard3_Click1(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string ins = "Insert into[MyCard](Name,Price,Quantity,Email) values('" + idli.Text + "','" + e3 + "','" + Label3.Text + "','" + Session["email"] + "')";
                SqlCommand com = new SqlCommand(ins, con);
        ...
        protected void update1_Click1(object sender, EventArgs e)
        {
            ...
            con.Open();
            string delete = "DELETE FROM MyCard WHERE Name = 'Paper Dosa'";
        ...
        protected void update2_Click1(object sender, EventArgs e)
        {
            ...
            con.Open();
            string delete = "DELETE FROM MyCard WHERE Name = 'Masala Dosa'";
            SqlCommand com = new SqlCommand(delete, con);
            com.ExecuteNonQuery();
            con.Close();
        }
        ...
        protected void update3_Click1(object sender, EventArgs e)
        {
            ...
            con.Open();
            string delete = "DELETE FROM MyCard WHERE Name = 'Idli'";
            SqlCommand com = new SqlCommand(delete, con);
            com.ExecuteNonQuery();
            con.Close();
        }
